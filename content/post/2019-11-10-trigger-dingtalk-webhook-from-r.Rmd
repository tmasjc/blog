---
title: Trigger Dingtalk Robot from R
author: tmasjc
date: '2019-11-10'
slug: trigger-dingtalk-webhook-from-r
categories: []
tags: 
    - httr
    - webhooks
...
Here I use the signature method to provide extra security. For this method to work, we need 3 piece of information. Token (1) and secret (2) can be obtained from the webhook setting. Signing (3) process is demonstrated below.
