...
The answer is **64%**. If you play the game the optimal game, you are able to win 64% of the time. For further analysis, we can explore the winning chances at any point of in the game. For an instance, if you are left with 10 flips and are 5 points behind, what are the odds of you winning the game at the end?
